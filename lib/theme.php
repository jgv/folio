...
class Theme extends Folio {
  ...
  function __construct($theme){
    ...
    $this->current_theme_dir = $this->dir . "/themes/" . $this->theme_name;
    $this->current_theme_path = "themes/" . $this->theme_name;
    ...
    @$document->loadHTMLFile($this->current_theme_dir . "/html/index.html");
  ...
  private function insert_css(){
    if ($this->css_files) {
      foreach($this->css_files as $css_file) {
        ...
        $link->setAttribute("href", $this->current_theme_path . "/stylesheets/" . $css_file);
